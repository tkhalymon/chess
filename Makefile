all: chess
chess: main.o board.o cell.o figure.o pngtex.o lodepng.o position.o pawn.o king.o queen.o bishop.o knight.o rook.o
	g++ -std=c++11 main.o board.o cell.o figure.o pngtex.o lodepng.o position.o pawn.o king.o queen.o bishop.o knight.o rook.o -lGL -lglut -o chess
